...
<head>
    ...
    <title>Welcome to Hi'bees Cravings</title>
    <style>
        @media  all {
            /* cyrillic-ext */
            @font-face {
    ...
    <style>
        @media (max-width: 620px) {
            ...
            th.pc-w620-spacing-0-0-70-0{margin: 0 !important;padding: 0px 0px 70px 0px !important;}
            table.pc-w620-spacing-0-0-10-0 {margin: 0px 0px 10px 0px !important;}
            td.pc-w620-spacing-0-0-10-0,
            th.pc-w620-spacing-0-0-10-0{margin: 0 !important;padding: 0px 0px 10px 0px !important;}
            ...
            .pc-w620-view-vertical,.pc-w620-view-vertical > tbody,.pc-w620-view-vertical > tbody > tr,.pc-w620-view-vertical > tbody > tr > th,.pc-w620-view-vertical > tr,.pc-w620-view-vertical > tr > th {display: block !important;width: 100% !important;}
        ...
        @media (max-width: 520px) {
            ...
            th.pc-w520-spacing-0-0-50-0{margin: 0 !important;padding: 0px 0px 50px 0px !important;}
    ...
    <style>
        @media screen { @font-face { font-family: 'Fira Sans'; font-style: normal; font-weight: 400; src: url('https://fonts.gstatic.com/s/firasans/v16/va9E4kDNxMZdWfMOD5VvmYjN.woff') format('woff'), url('https://fonts.gstatic.com/s/firasans/v16/va9E4kDNxMZdWfMOD5VvmYjL.woff2') format('woff2'); } @font-face { font-family: 'Fira Sans'; font-style: normal; font-weight: 500; src: url('https://fonts.gstatic.com/s/firasans/v16/va9B4kDNxMZdWfMOD5VnZKveSBf8.woff') format('woff'), url('https://fonts.gstatic.com/s/firasans/v16/va9B4kDNxMZdWfMOD5VnZKveSBf6.woff2') format('woff2'); } @font-face { font-family: 'Fira Sans'; font-style: normal; font-weight: 800; src: url('https://fonts.gstatic.com/s/firasans/v16/va9B4kDNxMZdWfMOD5VnMK7eSBf8.woff') format('woff'), url('https://fonts.gstatic.com/s/firasans/v16/va9B4kDNxMZdWfMOD5VnMK7eSBf6.woff2') format('woff2'); } }
    </style>

</head>

<body class="pc-font-alt" style="width: 100% !important;min-height: 100% !important;margin: 0 !important;padding: 0 !important;font-family: 'Fira Sans', Helvetica, Arial, sans-serif;line-height: 1.5;color: #2D3A41;mso-line-height-rule: exactly;-webkit-font-smoothing: antialiased;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;font-variant-ligatures: none;text-rendering: optimizeLegibility;-moz-osx-font-smoothing: grayscale;background-color: #f4f4f4;">
                            ...
                            <tr>
                                <td style="padding: 0px 0px 0px 0px;">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                        <tr>
                                            <!--[if !gte mso 9]><!-->
                                            <td valign="top" class="pc-w520-padding-27-30-27-30 pc-w620-padding-32-35-32-35" style="background-image: url('https://res.cloudinary.com/frontedge/image/upload/v1655298468/ethnocpia/4884628_tzqjng.jpg'); background-size: cover; background-position: center; background-repeat: no-repeat;padding: 37px 40px 37px 40px;border-radius: 0px;background-color: #1B1B1B;" bgcolor="#1B1B1B">

                                                <table class="text-block" border="0" cellpadding="0" role="presentation" width="100%" align="left">
                                                    <tr class="text-block-tr">
                                                        <td valign="top" class="text-block-td pc-font-alt pc-w620-fontSize-30 pc-w620-lineHeight-40" style="mso-line-height: exactly;line-height: 46px;letter-spacing: -0.6px;font-family: 'Fira Sans', Helvetica, Arial, sans-serif;font-size: 36px;font-weight: 800;color: #0c0b0b;text-align: left;" align="left">
                                                            Hi'bees</td>
                                                    </tr>
                                                </table>
                            ...
                            <tr>
                                <td style="padding: 0px 0px 0px 0px;">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                        <tr>
                                            <!--[if !gte mso 9]><!-->
                                            <td valign="top" style="background-image: url('https://res.cloudinary.com/frontedge/image/upload/v1655295160/ethnocpia/1315769_bvyk7l.jpg'); background-size: cover; background-position: center; background-repeat: no-repeat;padding: 80px 60px 10px 60px;border-radius: 0px 0px 0px 0px;background-color: transparent;" bgcolor="transparent">

                                                <table class="text-block-wrapper" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                    <tr>
                                                        <td class="text-block-wrapper-td" style="padding: 0px 0px 10px 0px;mso-padding-left-alt: 0; margin-left: 0px;" valign="top" align="left">
                                                            <table class="text-block" border="0" cellpadding="0" role="presentation" width="100%" align="left">
                                                                <tr class="text-block-tr">
                                                                    <td valign="top" class="text-block-td pc-font-alt" style="padding: 0px 0px 0px 0px;mso-line-height: exactly;line-height: 55px;letter-spacing: -0.6px;font-family: 'Georgia', Helvetica, Arial, sans-serif;font-size: 30px;font-weight: normal;color: #000000;text-align: left;" align="left">
                                                                        Hi ${name},</td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                ...
                                                <table class="text-block-wrapper" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                    <tr>
                                                        <td class="text-block-wrapper-td" style="padding: 150px 0px 0px 0px;mso-padding-left-alt: 0; margin-left: 0px;" valign="top" align="justify">
                                                            <table class="text-block" border="0" cellpadding="0" role="presentation" width="100%" align="justify">
                                                                <tr class="text-block-tr">
                                                                    <br>
                                                                    <br>
                                                                    <td valign="top" class="text-block-td pc-font-alt" style="padding: 0px 0px 0px 0px;mso-line-height: exactly;line-height: 28px;letter-spacing: -0.2px;font-family: 'Trebuchet MS', Helvetica, Arial, sans-serif;font-size: 20px;font-weight: normal;color: #ffffff;text-align: justify;" align="justify">
                                                                        <br>
                                                                        <br>
                                                                        <br>
                                                ...
                                                <table class="list-wrapper" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                    <tr class="list-wrapper-tr">
                                                        <td class="list-wrapper-td" valign="top" style="padding: 0px 0px 0px 0px;">
                                                            <table class="list" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                                <tr class="list-tr">
                                                                    <td class="list-td" valign="top" align="center" style="padding: 0px 0px 0px 0px;">
                                                                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" class="list-horizontal pc-w620-view-vertical">
                                                                            <tr class="list-horizontal-tr">
                                                                                <th class="button-wrapper-td" align="center" valign="top" style="font-weight: normal;">
                                                                                    <table class="button" align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse: separate;">
                                                                                        <br>
                                                                                        <br>
                                                                                        <tr class="button-tr">

                                                                                            <td class="button-td" valign="middle" style="border-radius: 0px 0px 0px 0px;background-color: #000000;padding: 14px 18px 14px 18px;mso-padding-left-alt: 0; margin-left: 18px;height:24px;">
                                                                                                <a class="pc-font-alt" href="${url}" style="display: inline-block;text-decoration: none;font-family: 'Georgia', Helvetica, Arial, sans-serif;font-weight: normal;font-size: 16px;line-height: 24px;letter-spacing: -0.2px;color: #ffffff;">Reset Password</a>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </th>
                                                ...
                                                <table class="text-block" border="0" cellpadding="0" role="presentation" width="100%" align="center">
                                                    <tr class="text-block-tr">
                                                        <td valign="top" class="text-block-td pc-font-alt" style="mso-line-height: exactly;line-height: 28px;letter-spacing: -0.2px;font-family: 'Georgia', Helvetica, Arial, sans-serif;font-size: 18px;font-weight: normal;color: #ffffff;text-align: center;" align="center">
                                                            <br>
                                                        </td>
                                                    </tr>
                                                </table>
                                                <!--[if gte mso 9]>
                                                                                   ...
                                                                                   <tr>
                                                                                       <td colspan="3" height="10" style="line-height: 1px; font-size: 1px;">&nbsp;</td>
                                                                                   </tr>
                                                                               </table>
                                                                           </td>
                                                                       </tr>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                            <tr>
                                <td style="padding: 0px 0px 0px 0px;">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                        <tr>
                                            <td valign="top" class="pc-w520-padding-10-10-10-10 pc-w620-padding-15-15-15-15" style="padding: 20px 20px 20px 20px;border-radius: 0px;background-color: #741818;" bgcolor="#741818">
                                                <table class="list" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                    <tr class="list-tr">
                                                        <td class="list-td" valign="top">
                                                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" class="list-horizontal pc-w620-view-vertical">
                                                                <tr class="list-horizontal-tr">
                                                                    <th class="card-container-td" width="50%" valign="top" style="font-weight: normal; text-align: left; width: 50%;">
                                                                        <table class="card" border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                                                            <tr class="card-tr">
                                                                                <td valign="top" class="card-td" style="padding: 20px 20px 20px 20px;">
                                                                                    <table class="card-inner" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                                                        <tr>
                                                                                            <th class="text-block-container-td" valign="top" style="font-weight: normal; text-align: left;   padding: 0px 0px 10px 0px;">
                                                                                                <table class="text-block" border="0" cellpadding="0" role="presentation" width="100%">
                                                                                                    <tr class="text-block-tr">
                                                                                                        <td valign="top" class="text-block-td pc-font-alt" style="mso-line-height: exactly;line-height: 24px;font-family: 'Fira Sans', Helvetica, Arial, sans-serif;font-size: 18px;font-weight: 500;color: #ffffff;">
                                                                                                            Follow Us.</td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                            </th>
                                                                                        ...
                                                                                        <tr>
                                                                                            <th class="text-block-container-td pc-w620-spacing-0-0-22-0" valign="top" style="font-weight: normal; text-align: left;   padding: 0px 0px 52px 0px;">
                                                                                                <table class="text-block" border="0" cellpadding="0" role="presentation" width="100%">
                                                                                                    <tr class="text-block-tr">
                                                                                                        <td valign="top" class="text-block-td pc-font-alt" style="mso-line-height: exactly;line-height: 20px;letter-spacing: -0.2px;font-family: 'Fira Sans', Helvetica, Arial, sans-serif;font-size: 14px;font-weight: normal;color: #d8d8d8;">
                                                                                        ...
                                                                                        <tr>
                                                                                            <th valign="top" style="font-weight: normal; text-align: left;">
                                                                                                <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                                                                    <tr>
                                                                                                        <td class="link-block-wrapper-td" style="padding: 0px 0px 8px 0px;" align="left">
                                                                                                            <table class="link-block" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                                                                                <tr class="link-block-tr">
                                                                                                                    <td valign="top" class="link-block-td" align="left">
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            </table>
                                                                                                        </td>
